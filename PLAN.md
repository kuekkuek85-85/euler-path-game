...
| B02 도전 회로 | 매번 새 도형(무한 모드) | **고정 미션 3개 (B02·B03·B04, 간선 12·13·14)** | 2026-09-01 작성자 결정. 도형이 고정되어야 "최단 시간" 순위를 서로 비교할 수 있다. 도형은 `lib/generator.ts`로 뽑아 `stages.json`에 심었다 |
