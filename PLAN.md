...
| 항목 | 이전 | 지금 |
|---|---|---|
| 개수 | 24개 (본편 12 + 보너스 13) | **30개 (1레벨 10 + 2레벨 10 + 3레벨 10)** |
| id | `S01` `B02` `C03` `D01` | `L1-01`~`L1-10`, `L2-01`~`L2-10`, `L3-01`~`L3-10` |
...
### 5.2 검증 방법
- 유닛테스트 203개: 대조표, 연결성, 모든 유효 시작점에서의 해 존재,
  좌표 범위, 점 사이 최소 간격(12 viewBox 단위 ≈ 43px), 중복 간선.
- 브라우저: 30개 전부를 앱 자신의 `solve()`가 낸 경로대로 실제 드래그해 클리어.
  30/30 성공, 콘솔 오류 없음.
