...
미션은 **1레벨 10개(L1-01~L1-10)**, **2레벨 10개(L2-01~L2-10)**,
**3레벨(L3-01~, 현재 5개 — 나머지 5개는 추가 예정)** 이다. 앞 스테이지를 깨야 다음이 열린다.
...
| (여유) | — | 먼저 끝낸 학생은 2레벨 뒤쪽(L2-07~L2-10)으로 |
...
```
src/
  data/stages.json      스테이지 데이터 (1레벨 10 + 2레벨 10 + 3레벨 5)
